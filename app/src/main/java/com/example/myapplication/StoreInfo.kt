...
data class Store(val address: String, val phone: String, val phoneDisplay: String)

object StoreInfo {
    val stores = listOf(
        Store("ул. Хрусталёва, 111", "+79782195625", "+7 (978) 219-56-25"),
        Store("пр. Октябрьской Революции, 20", "+79785407888", "+7 (978) 540-78-88")
    )
